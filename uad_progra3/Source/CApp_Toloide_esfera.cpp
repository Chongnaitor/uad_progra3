...
/* */
CApp_Toloide_esfera::CApp_Toloide_esfera() :
	CApp_Toloide_esfera(CGameWindow::DEFAULT_WINDOW_WIDTH, CGameWindow::DEFAULT_WINDOW_HEIGHT)
{
}

/* */
CApp_Toloide_esfera::CApp_Toloide_esfera(int window_width, int window_height) :
	...
	m_numFaces{ 0 }
{
	cout << "Constructor: CApp_Toloide_esfera(int window_width, int window_height)" << endl;
...
CApp_Toloide_esfera::~CApp_Toloide_esfera()
{
	cout << "Destructor: ~CApp_Toloide_esfera()" << endl;
...
void CApp_Toloide_esfera::initialize()
{
	
		int    idx = 0;
		float  cubeSize = 2.0f;

		m_numFaces = 18 * 3.16; // 6 quads * 2 triangles per quad
		...
		int             numFaceIndices = m_numFaces * 18;                     // 12 triangles * 3 vertex indices per face
...
/* */
void CApp_Toloide_esfera::update(double deltaTime)
{
...
/* */
void CApp_Toloide_esfera::render()
{
...
/* */
void CApp_Toloide_esfera::onMouseMove(float deltaX, float deltaY)
{
...
/* */
void CApp_Toloide_esfera::executeMenuAction()
{
	if (getMenu() != NULL)
	{
